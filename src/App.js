...
//     // If an email is found in the URL, identify the user in PostHog
//     if (email) {
//       posthog.identify(email, {
//         email: email,
//       });

//       // Optionally, you can capture a specific event for user identification
...
//       <CssBaseline />
//       <Router>
//         <UserTracking /> {/* Include the user tracking component */}
//         <Layout>
//           <Routes>
//             <Route path="/" element={<Home />} />
//             <Route path="/Login" element={<Login />} />
